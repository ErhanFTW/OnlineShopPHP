...
$query2="UPDATE user SET Vorname = '$user[1]', Name = '$user[2]',Passwort =$passwort,Mail='$user[3]', Straße='$user[4]',  Hausnummer='$user[5]', PLZ='$user[6]', Ort='$user[7]', Verein='$user[8]' WHERE Nummer = '$_SESSION[usernummer]'";
