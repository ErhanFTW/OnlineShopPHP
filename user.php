...
$query="Select Nummer,Vorname, Name, Mail,Straﬂe,Hausnummer,PLZ,Ort from user";
...
echo"<table><tr><td>Nummer</td><td>Vorname</td><td>Nachname</td><td>Email</td><td>Straﬂe</td><td>Hausnummer</td><td>PLZ</td><td>Ort</td></tr>";
