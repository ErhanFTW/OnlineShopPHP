...
<div align="center">
  <table border="1" cellpadding="4" width="600" rules="groups" >
	...
	<tr>
	  ...
	  <td width="120"></td>
	  <td width="240"><?php echo "<input type=\"text\" name=\"Strasse\" value=\"$_SESSION[straße]\"><input type=\"text\" name=\"Hausnummer\" value=\"$_SESSION[hausnummer]\" size=\"5\">";?></td>
	</tr>
	<tr>
      <td width="120"></td>
      <td width="120"></td>
	...
	<tr>
      <td width="120"></td>
      <td width="120"></td>
	  <td width="120" align="center"><input type="button" value=Zur&uuml;ck onClick="window.location.href='seite.php?.SID.'"><input type="submit" value="&Auml;ndern"><input type="submit" name="Löschen" value="L&ouml;schen"></td>
	  <td width="240"></td>
