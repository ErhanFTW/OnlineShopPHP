...
$query2="Select Artikelnummer,Name,Verein,Bild from artikel where artikelnummer='$bestellung[Artikelnummer]'";
...
while ($row = mysql_fetch_array($result2)) {
 ...
 if ($test=="1"){echo"<tr><td>Artikelnummer</td><td>Name</td><td>Verein</td><td>Bild</td><td>Anzahl</td><td>Bestelltag<td>Status</td></td>";}
