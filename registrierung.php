...
if ($user[1]=="" or $user[2]=="" or $user[3]=="" or $user[4]=="" or $user[5]=="" or $user[6]=="" or $user[7]=="" or $user[8]==""){
 ...
 //User�berpr�fung, wurde der Name+Mail oder nur Mailadresse schon einmal verwendet
...
//Einf�gen der Userdaten in Datenbank User
  ...
  //Wenn erfolgreiche �bertragung, dann Ausgabe aller Userdaten des Users
  if($result){
      ...
      <tr><td>Stra�e:</td><td>$user[5]</td> </tr>
