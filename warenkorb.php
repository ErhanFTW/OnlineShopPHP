...
if (!isset($db)) {
    ...
    //Es wird überprüft, ob die Person angemeldet ist. Wenn nicht dann wird das Script abgebrochen.
      ...
      <tr><td>Gesamtpreis:</td><td>$gpreis €</td></tr>
                        ...
                        $query4 = "SELECT Artikelnummer, Name, Preis FROM artikel where Artikelnummer='$line[0]'";
...
//Abrufen der Daten des Artikels, der ausgewählt wurden
                        ...
                        while ($row = mysql_fetch_array($result4)) {
                            ...
                            $preis = $artikel * $row[3];
                            $query = "INSERT INTO warenkorb (Usernummer, Artikelnummer, Name, Preis, Anzahl, Gesamtpreis) values ('$usernummer',";
                            $query .= "'" . $row[0] . "',";
                            $query .= "'" . $row[1] . "',";
                            $query .= "'" . $row[2] . "',";
                            $query .= "'$artikel',";
